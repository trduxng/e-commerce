...
import { normalizeProductList, sampleCategories, sampleProducts } from "../data/shopData";
              ...
              <Link className="text-decoration-none" to={`/shop?categoryId=${category.id}`}>
                <div className="cat-item d-flex align-items-center mb-4">
                  <div className="overflow-hidden" style={{ width: "100px", height: "100px" }}>
                    <img className="img-fluid" src={category.image || `/img/cat-${(index % 4) + 1}.jpg`} alt={category.name} />
                  </div>
