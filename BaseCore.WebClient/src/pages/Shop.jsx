...
const Shop = () => {
  ...
  const selectedPrice = priceRanges[priceIndex] || priceRanges[0];
  ...
  useEffect(() => {
    ...
    loadShop();
  }, [keyword, categoryId, selectedPrice.min, selectedPrice.max]);
              ...
              {priceRanges.map((range, index) => (
                <div key={range.label} className="custom-control custom-radio d-flex align-items-center justify-content-between mb-3">
                  ...
                  <span className="badge border font-weight-normal">
                    {range.max === null ? "" : formatCurrency(range.max)}
                  </span>
                </div>
              ))}
            </div>
              ...
              <div className="col-12 pb-1">
                <div className="d-flex align-items-center justify-content-between mb-4">
                  ...
                  <div className="d-flex align-items-center">
                    <small className="text-muted mr-3">{totalCount} products</small>
